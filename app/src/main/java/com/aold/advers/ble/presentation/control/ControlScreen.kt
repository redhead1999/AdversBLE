...
import com.aold.advers.ble.presentation.scan.device.ConnectButtons
...
@PortraitLayouts
@Composable
fun PreviewPortraitСontrol(
    @PreviewParameter(PortraitListParams::class) featureParams: FeatureParams
) {
    AdversBleTheme() {
        ControlScreen(appLayoutInfo = featureParams.appLayoutInfo) {
