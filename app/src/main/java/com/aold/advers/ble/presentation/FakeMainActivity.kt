...
import kotlinx.android.synthetic.main.fake_activity_main.scan_button
import kotlinx.android.synthetic.main.fake_activity_main.scan_results_recycler_view
    ...
    private val scanResultAdapter: ScanResultAdapter by lazy {
        ScanResultAdapter(scanResults) { result ->
            ...
            with(result.device) {
                ...
                ConnectionManager.connect(this, this@FakeMainActivity)
            }
        }
    }
    ...
    private val connectionEventListener by lazy {
        ConnectionEventListener().apply {
            onConnectionSetupComplete = { gatt ->
                Intent(this@FakeMainActivity, BleOperationsActivity::class.java).also {
