...
import com.aold.advers.ble.presentation.help.LegalStuff
    ...
    Column(
        ...
        OutlinedCard(
            ...
            Column(
                ...
                Text(
                    text = "Прежде чем вы сможете начать сканирование устройств BLE, сначала Вам нужно включить некоторые разрешения Bluetooth и местоположения.",
                )
...
//) {
//    AdversBleTheme(dynamicColor = false) {
//        Surface() {
//            ShowPermissions(
