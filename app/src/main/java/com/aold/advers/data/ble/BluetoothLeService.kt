...
class BluetoothLeService : Service() {
    ...
    private fun broadcastUpdate(action: String,
        ...
        if (UUID_ADVERS_HEATER== characteristic.uuid) {
            ...
            if (flag and 0x01 != 0) {
                ...
                Log.d(TAG, "ADVERS HEATER UINT16.")
            } else {
                format = BluetoothGattCharacteristic.FORMAT_UINT8
                Log.d(TAG, "ADVERS HEATER UINT8.")
            }
    ...
    fun setCharacteristicNotification(characteristic: BluetoothGattCharacteristic,
        ...
        if (UUID_ADVERS_HEATER == characteristic.uuid) {
            val descriptor = characteristic.getDescriptor(
                UUID.fromString(SampleGattAttributes.CLEINT_DEVICE))
    ...
    companion object {
        ...
        val UUID_ADVERS_HEATER = UUID.fromString(SampleGattAttributes.ADVERS_HEATER)
    }
}